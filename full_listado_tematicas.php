...
<body>
    <header>
        ...
        <a href="alta_tematica.php" class="button">Alta Tematica <i class='far fa-plus-square'></i></a>
        <a href="alta_masiva_tematicas.php" class="button">Alta masiva de Tematicas <i class='far fa-plus-square'></i></a>
